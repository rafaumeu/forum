...
import { DeleteAnswerCommentsUseCase } from '@forum/domain/src/domain/forum/application/use-cases/delete-answer-comment'
...
export function deleteAnswerCommentController(app: FastifyInstance) {
  app.withTypeProvider<ZodTypeProvider>().delete(
    ...
    async (request, reply) => {
      ...
      const deleteAnswerCommentUseCase = new DeleteAnswerCommentsUseCase(
