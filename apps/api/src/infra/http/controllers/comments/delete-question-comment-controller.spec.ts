...
describe('Delete Question Comment (E2E)', () => {
  it('should delete a question comment (auth + owner)', async () => {
    ...
    const commentResponse = await supertest(app.server)
    ...
    const commentId = commentResponse.body.questionComment.id
  ...
  it('should not delete another users comment', async () => {
